                    ...
                    <div class="col-sm-8 mTop-30">
                        <div class="inner-wrap frameLR bg-white shadow clearfix ">
                            ...
                            <div class="widget contact-widget">
                                ...
                                <form class="contact-form clearfix" id="contact" novalidate="novalidate">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-12">
                                            <p class="input-block">
                                                ...
                                                <input name="website" type="text" class="form-control" placeholder="Web site">
                                    ...
                                    <p class="contact-button clearfix">
                                        ...
                                        <input onclick="saveConatct()" type="button" class="btn btn-raised ripple-effect btn-success"id="submit-contact" value="Send message">
                                    </p>
                                </form>
                                <div id="response">
                                </div>
